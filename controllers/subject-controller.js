...
// const AddTarget = async (req, res) => {
//   const { docid, Target } = req.body; // Extract document ID and target data from request body

//   try {
//     // Find the ExcelSchema document based on the document ID
//     let excelDoc = await sampleExcelSchema.findById(docid);
...
const AddCOPOArticulationMatrix = async (req, res) => {
  ...
  // const result = await sampleExcelSchema.create(dataToInsert)
  // for (const item of dataToInsert) {
  //   try {
  //     const result = await sampleExcelSchema.create(item);
  //   } catch (error) {
  ...
  // columnAverages.subject = "DSA"
  // console.log(columnAverages)

  // Save averages to MongoDB
